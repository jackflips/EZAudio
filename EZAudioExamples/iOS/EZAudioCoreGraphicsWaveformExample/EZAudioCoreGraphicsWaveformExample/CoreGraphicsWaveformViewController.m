...
- (void)viewDidLoad
{
    ...
    self.audioPlot.progressColor   = [UIColor blueColor];
    self.audioPlot.progress        = .5;
    // Plot type
    [self drawRollingBlocksScrollRightPlot];
...
- (void)drawRollingBlocksPlot {
    self.audioPlot.plotType = EZPlotTypeRollingBlocks;
    self.audioPlot.shouldFill = YES;
    self.audioPlot.shouldMirror = YES;
}

- (void)drawRollingBlocksScrollRightPlot {
    self.audioPlot.plotType = EZPlotTypeRollingBlocksScrollRightPlot;
    self.audioPlot.shouldFill = YES;
    self.audioPlot.shouldMirror = YES;
}
